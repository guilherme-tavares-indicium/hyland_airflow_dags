...
def task_builder(**kwargs):
    ...
    last_task = kwargs['task_instance'].task  # Keep track of the last task in the chain
    ...
    for i, stream_name in enumerate(streams):
        ...
        last_task >> subtask  # Set downstream dependency using bitshift operator
        last_task = subtask  # Update the last task in the chain
