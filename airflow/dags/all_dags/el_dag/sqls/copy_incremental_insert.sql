...
delete from {{ params.schema }}.{{ params.table_name }}
using {{ params.schema }}.{{ params.table_name }}_temp_{{ds}}
where {{ params.schema }}.{{ params.table_name }}.{{params.id_column}}={{ params.schema }}.{{ params.table_name }}_temp_{{ds}}.{{params.id_column}} 
